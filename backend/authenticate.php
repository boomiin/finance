        ...
        if ($result) {
          ...
          if ($email == $fetch_manager_result['email']) {
            ...
            if ($password == $fetch_manager_result['pass']) {
              ...
              echo "<script> alert('erreur mot de passe'); window.location.href='../forms/manager-login.php';</script>";
  
          }else 
            echo "<script> alert('mauvais email!'); window.location.href='../forms/manager-login.php';</script>"; 
      ...
      if ($result) {
        ...
        if ($email == $fetch_employee_result['email_address']) {
          ...
          if ($password == $fetch_employee_result['pass']) {
            ...
            $_SESSION['qualification'] = $fetch_employee_result['qualification'];
            header("Location: ../employee/employee-dashboard.php");

          }else 
            echo "<script> alert('erreur mot de passe'); window.location.href='../forms/employee-login.php';</script>";

        }else 
          echo "<script> alert('erreur email'); window.location.href='../forms/employee-login.php';</script>"; 
